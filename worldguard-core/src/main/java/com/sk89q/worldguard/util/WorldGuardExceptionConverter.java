...
public class WorldGuardExceptionConverter extends ExceptionConverterHelper {
    ...
    public void convert(RejectedExecutionException e) throws CommandException {
        throw newCommandException("Сейчас в очереди слишком много задач, чтобы добавить свои. Используйте / wg running для вывода списка запущенных и поставленных в очередь задач.", e);
    }
