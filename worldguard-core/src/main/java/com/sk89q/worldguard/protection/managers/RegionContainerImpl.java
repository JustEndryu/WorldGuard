                    ...
                    while (it.hasNext()) {
                        ...
                        try {
                            ...
                            if (e.getCause() != null && e.getCause().getMessage().equals(lastMsg)) {
                                ...
                                log.log(Level.WARNING, "Данные региона по-прежнему не загружаются, по крайней мере, для мира с названием'" + normal.toString() + "'");
                                break;
                            }
                            log.log(Level.WARNING, "Данные региона по-прежнему не загружаются, по крайней мере, для мира с названием '" + normal.toString() + "'", e);
